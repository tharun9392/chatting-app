  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-slate-50 dark:bg-dark-900 text-slate-800 dark:text-slate-200 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-500/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/20 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-[100px] animate-pulse-slow font-sans" style={{ animationDelay: '1s' }}></div>
      </div>
      ...
      <div className="z-10 relative text-center mb-8 animate-fade-in">
        ...
        <p className="text-slate-500 dark:text-slate-400 max-w-md mx-auto font-medium">End-to-end encrypted messaging for secure communication</p>
      </div>
